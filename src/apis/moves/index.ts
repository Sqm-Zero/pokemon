...
export const reqMoves = (): Move[] => {
    return [
        ...
        },
        {
            accuracy: '100',
            category: '物理',
            description: '制造斩龙之风刃攻击对手。必定击中对方要害。',
            move: '斩龙之刃',
            move_id: '13',
            power: '90',
            type: '妖精'
        },
        {
            ...
            category: '变化',
            description:
                '激烈地跳起战舞提高气势。大幅提高自己的攻击（2级）。且提升自身命中率（1级）。',
            move: '剑舞',
            move_id: '14',
            power: '0',
            type: '一般'
        },
        {
            ...
            category: '物理',
            description:
                '用镰刀或爪子等切斩对手进行攻击且容易击中要害（1级），可以用来切断纤细的树枝。',
            move: '居合斩',
            move_id: '15',
            power: '80',
            type: '虫'
        ...
        },
        {
            ...
            category: '变化',
            description:
                '吹飞对手，强制拉后备宝可梦上场。如果对手为野生宝可梦，战斗将直接结束（优先度-6）。',
            move: '吹飞',
            move_id: '18',
            power: '0',
            type: '一般'
        },
        {
            ...
            category: '物理',
            description:
                '第1回合飞上天空，第2回合攻击对手且提升自身速度（1级）。可以用来飞往曾经去过的城镇。',
            move: '飞翔',
            move_id: '19',
            power: '100',
            type: '飞行'
        ...
        },
        {
            ...
            category: '物理',
            description:
                '一边快速旋转，一边踢飞对手进行攻击。20%使对手畏缩。并提升自身速度（1级）。',
            move: '回旋踢',
            move_id: '27',
            power: '110',
            type: '格斗'
        ...
        },
        {
            ...
            category: '物理',
            description:
                '用身体上的刺向对手进行攻击。连续攻击2～5次。使用后几率降低防御（1级）并提升速度（1级）。',
            move: '龙刺',
            move_id: '31',
            power: '25',
            type: '龙'
        ...
        },
        {
            ...
            category: '变化',
            description:
                '放走对手，强制拉后备宝可梦上场。如果对手为野生宝可梦，战斗将直接结束（优先度-6）。',
            move: '吼叫',
            move_id: '46',
            power: '0',
            type: '一般'
        },
        {
            accuracy: '75',
            category: '变化',
            description: '让对手听舒适、美妙的歌声，从而陷入睡眠状态。（最多两回合）（优先度-1）',
            move: '唱歌',
            move_id: '47',
            power: '0',
            type: '一般'
        ...
        },
        {
            ...
            category: '变化',
            description:
                '用白雾覆盖身体。在5回合内不会让对手降低自己的能力。可率先使用（优先度+1）。',
            move: '白雾',
            move_id: '54',
            power: '0',
            type: '冰'
        ...
        },
        {
            ...
            category: '特殊',
            description:
                '（敌方全体）将猛烈的暴风雪刮向敌全方进行攻击。20%让对手陷入冰冻状态（雪天必中）。',
            move: '暴风雪',
            move_id: '59',
            power: '110',
            type: '冰'
        ...
        },
        {
            accuracy: '75',
            category: '变化',
            description: '撒出催眠粉，从而让对手陷入睡眠状态。（最多两回合）（优先度-1）',
            move: '催眠粉',
            move_id: '79',
            power: '0',
            type: '草'
        ...
        },
        {
            ...
            category: '变化',
            description:
                '让对手陷入剧毒状态。（只有毒系宝可梦可学习）每回合结束时损失最大HP的，伤害计数/16，计数从1增至15。',
            move: '剧毒',
            move_id: '92',
            power: '0',
            type: '毒'
        ...
        },
        {
            accuracy: '75',
            category: '变化',
            description: '施以诱导睡意的暗示，让对手陷入睡眠状态。（最多两回合）（优先度-1）',
            move: '催眠术',
            move_id: '95',
            power: '0',
            type: '超能力'
        ...
        },
        {
            ...
            category: '物理',
            description:
                '带着怒火向对方进行攻击，有30%几率灼伤对手。如果在使出招式后受到攻击的话，会因愤怒提高自身攻击（1级）。',
            move: '怒火冲天',
            move_id: '99',
            power: '80',
            type: '幽灵'
        ...
        },
        {
            ...
            category: '变化',
            description:
                '升起黑雾，将正在场上战斗的全体宝可梦的能力变回原点。可率先使用（优先度+1）。',
            move: '黑雾',
            move_id: '114',
            power: '0',
            type: '冰'
        ...
        },
        {
            accuracy: '95',
            category: '物理',
            description: '用非常坚固且厚实的贝壳，夹住对手进行攻击。连续攻击2~5次。',
            move: '贝壳夹击',
            move_id: '128',
            power: '25',
            type: '水'
        ...
        },
        {
            accuracy: '101',
            category: '变化',
            description: '将头脑清空，瞬间忘记某事，从而大幅提高自己的特防（2级）和命中率（1级）。',
            move: '瞬间失忆',
            move_id: '133',
            power: '0',
            type: '超能力'
        },
        {
            ...
            category: '变化',
            description:
                '集中精神折弯汤匙，从而大幅度提升自身特攻（2级）以及特防（1级）和命中率（1级）。',
            move: '折弯汤匙',
            move_id: '134',
            power: '0',
            type: '超能力'
        ...
        },
        {
            ...
            category: '变化',
            description:
                '撒满具有催眠效果的孢子，从而让对手陷入睡眠状态。（最多两回合）（优先度-1）',
            move: '蘑菇孢子',
            move_id: '147',
            power: '0',
            type: '草'
        ...
        },
        {
            accuracy: '101',
            category: '变化',
            description: '通过细胞的变化进行液化，从而大幅提高自己的特防（2级）和物防（1级）。',
            move: '溶化',
            move_id: '151',
            power: '0',
            type: '毒'
        ...
        },
        {
            ...
            category: '变化',
            description:
                '强化自身的钢铁躯体，从而大幅度提高自己的攻击（2级）和特防（1级）但会降低自身速度（1级）',
            move: '钢铁之躯',
            move_id: '159',
            power: '0',
            type: '钢'
        ...
        },
        {
            accuracy: '100',
            category: '物理',
            description: '连续3次踢对手进行攻击。每踢中一次，威力就会提高。必定击中对方要害。',
            move: '瞬影三击',
            move_id: '167',
            power: '10',
            type: '格斗'
        ...
        },
        {
            accuracy: '101',
            category: '变化',
            description: '设下天罗地网使其被束缚。并降低对方双防（2级）。',
            move: '天罗地网',
            move_id: '169',
            power: '0',
            type: '虫'
        ...
        },
        {
            ...
            category: '变化',
            description:
                '幽灵属性时减少自身HP并让对方进入诅咒状态。非幽灵属性时，自身物攻和防御上升1级，速度下降1级',
            move: '诅咒',
            move_id: '174',
            power: '0',
            type: '幽灵'
        ...
        },
        {
            ...
            category: '特殊',
            description:
                '发射大炮一样的电流进行攻击。有几率击中对方要害（2级）且50%几率对手陷入麻痹状态。',
            move: '怒雷',
            move_id: '192',
            power: '110',
            type: '电'
        ...
        },
        {
            ...
            category: '物理',
            description:
                '（敌方全体）龙之逆鳞、触之必死！攻击有50%几率造成混乱效果。但2-3回合后自身会混乱。',
            move: '龙之逆鳞',
            move_id: '200',
            power: '130',
            type: '龙'
        },
        {
            ...
            category: '变化',
            description:
                '在5回合内扬起沙暴，除岩石、地面和钢以外，受到最大HP1/16的伤害。岩石属性的特防还会提高50%。',
            move: '沙暴',
            move_id: '201',
            power: '0',
            type: '岩石'
        ...
        },
        {
            accuracy: '100',
            category: '物理',
            description: '迅猛无比的电击，必定击中对方的要害。使用后提升自身速度（1级）。',
            move: '电电加速',
            move_id: '209',
            power: '50',
            type: '电'
        },
        {
            ...
            category: '物理',
            description:
                '用镰刀或爪子等切斩对手进行攻击。连续击中，威力就会翻倍。如果不击中则伤害重置（最高160威力）',
            move: '连斩',
            move_id: '210',
            power: '40',
            type: '虫'
        ...
        },
        {
            accuracy: '100',
            category: '物理',
            description: '用亿万吨力量的拳头猛烈的攻击对手。无视守护且必定眩晕。',
            move: '亿万吨重击',
            move_id: '223',
            power: '130',
            type: '一般'
        ...
        },
        {
            ...
            category: '物理',
            description:
                '通过旋转来攻击对手。还可以摆脱绑紧、紧束、寄生种子和撒菱等招式。并提升速度（1级）。',
            move: '高速旋转',
            move_id: '229',
            power: '50',
            type: '地面'
        ...
        },
        {
            ...
            category: '变化',
            description:
                '晴天下回复自身最大HP的2/3。没有天气则回复自身最大HP的1/2，其他天气则是最大HP的1/4。',
            move: '晨光',
            move_id: '234',
            power: '0',
            type: '一般'
        ...
        },
        {
            ...
            category: '变化',
            description:
                '在5回合内一直降雨，从而提高水属性的招式威力50%。火属性的招式威力则降低50%。',
            move: '求雨',
            move_id: '240',
            power: '0',
            type: '水'
        },
        {
            ...
            category: '变化',
            description:
                '在5回合内阳光变得强烈，从而提高火属性的招式威力50%。水属性的招式威力则降低50%。',
            move: '大晴天',
            move_id: '241',
            power: '0',
            type: '火'
        ...
        },
        {
            ...
            category: '变化',
            description:
                '在5回合内一直降冰雹，除冰属性的宝可梦以外，给予全体宝可梦伤害最大HP的1/16。',
            move: '冰雹',
            move_id: '258',
            power: '0',
            type: '冰'
        ...
        },
        {
            ...
            category: '变化',
            description:
                '当对手使出会变成异常状态的招式或寄生种子等时，会将对手的招式反射回去（优先度+4）。',
            move: '魔法反射',
            move_id: '277',
            power: '0',
            type: '超能力'
        ...
        },
        {
            ...
            category: '物理',
            description:
                '第1回合潜入水中，第2回合猛袭且提升特防（1级）。可潜入水底探索大海或沉船。',
            move: '潜水',
            move_id: '291',
            power: '100',
            type: '水'
        ...
        },
        {
            ...
            category: '变化',
            description:
                '一旦使用此招式就会降低队友的速度。在5回合内减弱电属性的招式。（坑队友专用技能）',
            move: '玩泥巴',
            move_id: '300',
            power: '0',
            type: '地面'
        ...
        },
        {
            accuracy: '100',
            category: '变化',
            description: '装哭流泪。使对手不知所措，从而大幅降低对手的特攻（2级）。',
            move: '假哭',
            move_id: '313',
            power: '0',
            type: '妖精'
        ...
        },
        {
            ...
            category: '特殊',
            description:
                '使出全部力量攻击对手。使用之后会因为反作用力，自己的特攻大幅降低（2级）。',
            move: '过热',
            move_id: '315',
            power: '120',
            type: '火'
        ...
        },
        {
            accuracy: '75',
            category: '变化',
            description: '让对手听舒适的笛声，从而陷入睡眠状态。（最多两回合）（优先度-1）',
            move: '草笛',
            move_id: '320',
            power: '0',
            type: '草'
        ...
        },
        {
            ...
            category: '物理',
            description:
                '蓄满力量用上勾拳顶起对手造成重伤。攻击15%几率附带眩晕和畏缩。（对正在飞翔的宝可梦也可以造成伤害）',
            move: '升龙烈破',
            move_id: '327',
            power: '110',
            type: '格斗'
        ...
        },
        {
            accuracy: '101',
            category: '变化',
            description: '将皮肤变得坚硬如铁，从而大幅提高自己的防御（2级）和命中（1级）。',
            move: '铁壁',
            move_id: '334',
            power: '0',
            type: '钢'
        ...
        },
        {
            ...
            category: '变化',
            description:
                '大声吼叫提高气势，从而提高我方的攻击和特攻（1级）可率先使用（优先度+1）。',
            move: '长嚎',
            move_id: '336',
            power: '0',
            type: '一般'
        ...
        },
        {
            ...
            category: '特殊',
            description:
                '集中精神使用破灭之力（优先度-6）。两回合后攻击对手且必定要害。使用后大幅度提升自身特攻、物防和特防（2级）。',
            move: '破灭之愿',
            move_id: '353',
            power: '100',
            type: '钢'
        ...
        },
        {
            ...
            category: '变化',
            description:
                '在5回合内，飘浮特性和飞行属性的宝可梦会被地面属性的招式击中。飞向空中的招式也将无法使用。',
            move: '重力',
            move_id: '356',
            power: '0',
            type: '超能力'
        ...
        },
        {
            accuracy: '100',
            category: '物理',
            description: '使出招式前，将最后受到的招式的伤害以150%伤害返还给对手。（优先度-5）',
            move: '金属爆炸',
            move_id: '368',
            power: '1',
            type: '钢'
        ...
        },
        {
            ...
            category: '变化',
            description:
                '让对手在5回合内不能使用宝可梦携带的道具。训练家也不能给那只宝可梦使用道具。',
            move: '查封',
            move_id: '373',
            power: '0',
            type: '恶'
        ...
        },
        {
            ...
            category: '物理',
            description:
                '用正义的力量惩罚目标目标提升能力越高伤害则越大。并提升自身攻击和速度（1级）。',
            move: '正义之罚',
            move_id: '386',
            power: '60',
            type: '恶'
        ...
        },
        {
            ...
            category: '物理',
            description:
                '让火焰覆盖全身猛撞向对手。自己也会受到不小的伤害（-33%）。10%让对手陷入灼伤状态。',
            move: '闪焰冲锋',
            move_id: '394',
            power: '120',
            type: '火'
        ...
        },
        {
            accuracy: '95',
            category: '物理',
            description: '种子携带爆炸般的力量，轰向对方两次。100%会使对手混乱。',
            move: '种子炸弹',
            move_id: '402',
            power: '50',
            type: '草'
        ...
        },
        {
            ...
            category: '变化',
            description:
                '制造出离奇的空间。在5回合内速度慢的宝可梦可以先行动。（先制度由-7调整为0）',
            move: '戏法空间',
            move_id: '433',
            power: '0',
            type: '超能力'
        },
        {
            accuracy: '100',
            category: '特殊',
            description: '（敌方全体）从天空中落下陨石攻击对方所有对手。',
            move: '龙星群',
            move_id: '434',
            power: '110',
            type: '龙'
        ...
        },
        {
            ...
            category: '特殊',
            description:
                '用尖尖的叶片向对手卷起风暴。使用之后因为反作用力自己的特攻会大幅降低（2级）。',
            move: '飞叶风暴',
            move_id: '437',
            power: '120',
            type: '草'
        ...
        },
        {
            ...
            category: '特殊',
            description:
                '放出无视守护且必中的制裁光弹。属性会根据自己携带的石板不同而改变。使用后增加自身物攻、特攻、速度（1级）。',
            move: '制裁光砾',
            move_id: '449',
            power: '150',
            type: '一般'
        ...
        },
        {
            ...
            category: '变化',
            description:
                '召唤手下，让其附在自己的身体上。可以提高自己的防御和特防（1级）。先制技能（优先度+1）。',
            move: '防御指令',
            move_id: '455',
            power: '0',
            type: '虫'
        ...
        },
        {
            ...
            category: '特殊',
            description:
                '第1回合消失踪影，第2回合攻击对手。即使对手正受保护，也能击中。并使其进入3回合挑衅状态。',
            move: '暗影潜袭',
            move_id: '467',
            power: '130',
            type: '幽灵'
        ...
        },
        {
            ...
            category: '变化',
            description:
                '将令人烦躁的粉末撒在自己身上吸引对手的注意。使对手的攻击全部指向自己。（对于草系无效）（优先度+2）',
            move: '愤怒粉',
            move_id: '476',
            power: '0',
            type: '虫'
        ...
        },
        {
            ...
            category: '变化',
            description:
                '制造出离奇的空间。在5回合内所有宝可梦携带道具的效果都会消失。可率先使用（优先度+1）。',
            move: '魔法空间',
            move_id: '478',
            power: '0',
            type: '超能力'
        },
        {
            ...
            category: '物理',
            description:
                '快速扔石头或炮弹，如果攻击飞行的对手，则会被击落，掉到地面。必定能够先制攻击（优先度+1）。',
            move: '冲岩',
            move_id: '479',
            power: '50',
            type: '岩石'
        },
        {
            accuracy: '100',
            category: '物理',
            description: '充满正义向对手使出制裁攻击。攻击必定会击中要害。并提升自身速度（1级）。',
            move: '制裁猛击',
            move_id: '480',
            power: '90',
            type: '格斗'
        ...
        },
        {
            ...
            category: '物理',
            description:
                '用沉重的身体撞向对手进行攻击。自己比对手越重，威力越大（最大威力为120）。',
            move: '重磅冲撞',
            move_id: '484',
            power: '1',
            type: '钢'
        ...
        },
        {
            accuracy: '101',
            category: '变化',
            description: '盘蜷着集中精神。提高自己的物防（2级）和特防（1级）。',
            move: '盘蜷',
            move_id: '489',
            power: '0',
            type: '毒'
        ...
        },
        {
            ...
            category: '变化',
            description:
                '打破外壳，降低自己的防御和特防（1级），但大幅提高攻击、特攻和速度（2级）。',
            move: '破壳',
            move_id: '504',
            power: '0',
            type: '一般'
        ...
        },
        {
            ...
            category: '物理',
            description:
                '第1回合将对手带到空中，第2回合将其摔下进行攻击。被带到空中的对手不能动弹。',
            move: '自由落体',
            move_id: '507',
            power: '60',
            type: '飞行'
        ...
        },
        {
            ...
            category: '物理',
            description:
                '扔飞对手，强制拉后备宝可梦上场。如果对手为野生宝可梦，战斗将直接结束（优先度-6）。',
            move: '巴投',
            move_id: '509',
            power: '70',
            type: '格斗'
        ...
        },
        {
            ...
            category: '特殊',
            description:
                '用水柱进行攻击。和火组合威力就会提高，天空中会挂上彩虹。自身特防增加一级（1级）。',
            move: '水之誓约',
            move_id: '518',
            power: '80',
            type: '水'
        },
        {
            ...
            category: '特殊',
            description:
                '用火柱进行攻击。和草组合威力就会提高，周围会变成火海。自身速度增加一级（1级）。',
            move: '火之誓约',
            move_id: '519',
            power: '80',
            type: '火'
        },
        {
            ...
            category: '特殊',
            description:
                '用草柱进行攻击。和水组合威力就会提高，周围会变成湿地。自身防御增加一级（1级）。',
            move: '草之誓约',
            move_id: '520',
            power: '80',
            type: '草'
        ...
        },
        {
            ...
            category: '物理',
            description:
                '弹飞对手，强制拉后备宝可梦上场。如果对手为野生宝可梦，战斗将直接结束（优先度-6）。',
            move: '龙尾',
            move_id: '525',
            power: '70',
            type: '龙'
        },
        {
            ...
            category: '变化',
            description:
                '一股超级强大的灵魂附身。虽会大幅度降低防御（2级）。但巨幅提升攻击（3级），且提升自身速度（1级）。',
            move: '大圣之魂',
            move_id: '526',
            power: '0',
            type: '火'
        ...
        },
        {
            ...
            category: '物理',
            description:
                '用燃烧的身体撞向对手进行攻击。自己比对手越重，威力越大（最大威力为120）。',
            move: '高温重压',
            move_id: '535',
            power: '1',
            type: '火'
        ...
        },
        {
            ...
            category: '变化',
            description:
                '用软绵绵的绒毛包裹住自己的身体进行守护。巨幅提高自身防御（3级），但会降低自身闪避（1级）。',
            move: '棉花防守',
            move_id: '538',
            power: '0',
            type: '草'
        ...
        },
        {
            ...
            category: '物理',
            description:
                '向对手投掷钢铁飞盘进行攻击。连续2次给予伤害。30%几率提升自身速度（1级）。',
            move: '钢铁飞盘',
            move_id: '544',
            power: '60',
            type: '钢'
        },
        {
            accuracy: '100',
            category: '物理',
            description: '大地的力量爆发出岩浆猛烈地攻击所有对手。',
            move: '地焰爆裂',
            move_id: '545',
            power: '120',
            type: '火'
        ...
        },
        {
            ...
            category: '特殊',
            description:
                '（敌方全体）让敌方听古老之歌，打动对手的内心进行攻击。30%让对手陷入睡眠状态。',
            move: '古老之歌',
            move_id: '547',
            power: '110',
            type: '一般'
        },
        {
            ...
            category: '特殊',
            description:
                '用长角切斩对手进行攻击。角上拥有的神奇力量将给予物理伤害。并使其5回合内无法使用道具。',
            move: '神秘之剑',
            move_id: '548',
            power: '120',
            type: '格斗'
        ...
        },
        {
            ...
            category: '特殊',
            description:
                '极致的火焰覆盖全身，振翅攻击对手。攻击后提高自身特攻、特防、速度（1级）。',
            move: '火神之舞',
            move_id: '552',
            power: '80',
            type: '火'
        },
        {
            ...
            category: '物理',
            description:
                '用覆盖着电流的冰块，在第2回合撞向对手。会让对手陷入麻痹状态（无视守住）。',
            move: '冰冻伏特',
            move_id: '553',
            power: '150',
            type: '冰'
        },
        {
            ...
            category: '特殊',
            description:
                '用能够冻结一切的强烈冷气，在第2回合包裹住对手。会让对手陷入灼伤状态（无视守住）。',
            move: '极寒冷焰',
            move_id: '554',
            power: '150',
            type: '冰'
        ...
        },
        {
            ...
            category: '物理',
            description:
                '从前额产生灼热的火焰，舍身撞击对手。会让对方进入挑衅状态。有几率击中要害（2级）。',
            move: '胜利之炎',
            move_id: '557',
            power: '140',
            type: '火'
        ...
        },
        {
            ...
            category: '物理',
            description:
                '使用致命的毒刺向敌方。必定击中对方要害。使用此招式打倒对手，攻击会大幅提高（2级）。',
            move: '致命针刺',
            move_id: '565',
            power: '75',
            type: '虫'
        },
        {
            ...
            category: '物理',
            description:
                '第1回合消失在某处，第2回合攻击对手且提升自身速度（1级）。可以无视守护进行攻击。',
            move: '潜灵奇袭',
            move_id: '566',
            power: '90',
            type: '幽灵'
        ...
        },
        {
            ...
            category: '变化',
            description:
                '（敌方全体）发出神兽怒吼威吓对手，从而大幅降低对手的攻击和特攻和速度（2级）。',
            move: '神之怒吼',
            move_id: '568',
            power: '0',
            type: '龙'
        ...
        },
        {
            ...
            category: '变化',
            description:
                '在5回合内变成青草场地。地面上的宝可梦每回合都能回复。草属性的招式威力还会提高。',
            move: '青草场地',
            move_id: '580',
            power: '0',
            type: '草'
        ...
        },
        {
            ...
            category: '变化',
            description:
                '防住对手攻击的同时，自己变为防御姿态。大幅降低所接触到的对手的攻击（2级）。',
            move: '王者盾牌',
            move_id: '588',
            power: '0',
            type: '钢'
        ...
        },
        {
            ...
            category: '变化',
            description:
                '将特殊的毒液泼向对手。对处于中毒状态的对手，其攻击、特攻和速度都会降低（1级）。',
            move: '毒液陷阱',
            move_id: '599',
            power: '0',
            type: '毒'
        ...
        },
        {
            accuracy: '101',
            category: '变化',
            description: '通过超强精神力强化自身！使自身物防、特防、速度大幅度提升（2级）。',
            move: '精神掌控',
            move_id: '601',
            power: '0',
            type: '超能力'
        ...
        },
        {
            ...
            category: '变化',
            description:
                '在5回合内变成电气场地。地面上的宝可梦将无法入眠。电属性的招式威力提高50%。',
            move: '电气场地',
            move_id: '604',
            power: '0',
            type: '电'
        ...
        },
        {
            ...
            category: '变化',
            description:
                '宝可梦为十分开心的你庆祝。能帮助队友增加攻击、特攻和命中率（1级）。可率先使用（优先度+5）。',
            move: '庆祝',
            move_id: '606',
            power: '0',
            type: '一般'
        },
        {
            ...
            category: '变化',
            description:
                '我方宝可梦之间帮忙。能帮助队友增加防御、特防和命中。可率先使用（优先度+5）。',
            move: '帮手',
            move_id: '607',
            power: '0',
            type: '一般'
        ...
        },
        {
            ...
            category: '物理',
            description:
                '全心集中自己的精神，使自己的拳头慢慢变硬。打中对手攻击和命中就会提高（1级）。',
            move: '蓄能龙拳',
            move_id: '612',
            power: '60',
            type: '龙'
        },
        {
            ...
            category: '物理',
            description:
                '用死亡的力量锁定对手身上吸取HP。回复给予对手伤害的全部HP。必定命中无法躲开（无视替身）。',
            move: '死亡之翼',
            move_id: '613',
            power: '110',
            type: '飞行'
        ...
        },
        {
            ...
            category: '物理',
            description:
                '（敌方全体）从地面掀起波浪进行攻击。被掀入波浪中的敌方会降低速度（1级）且无法逃跑。',
            move: '千波激荡',
            move_id: '615',
            power: '110',
            type: '地面'
        ...
        },
        {
            accuracy: '100',
            category: '物理',
            description: '（敌方全体）将大地的力量变化为岩石之柱攻击对手。50%几率让对方混乱。',
            move: '裁决之柱',
            move_id: '619',
            power: '110',
            type: '岩石'
        },
        {
            accuracy: '100',
            category: '物理',
            description: '从天空中急速下降攻击对手。无视对方的守护、且有几率命中对方要害（2级）。',
            move: '画龙点睛',
            move_id: '620',
            power: '140',
            type: '飞行'
        },
        {
            ...
            category: '物理',
            description:
                '无视对手的守住或看穿等招式进行连续攻击，并让敌方进入挑衅状态3回合（无视替身）。解放形态方可使用。',
            move: '异次元猛攻',
            move_id: '621',
            power: '140',
            type: '幽灵'
